...
function index() {
  ...
  const isNewProduct = (createdAt) => {
    ...
    return diffInDays <= 30; // Considérer comme nouveau si créé dans les 30 derniers jours
  };
                      ...
                      <div className="flex flex-col justify-center items-center">
                        ...
                        <div className="flex flex-col py-2 bg-white w-full">
                          ...
                          <button
                            onClick={() => addToCart(product)}
                            disabled={product.stock < 1}
                            className={`md:hidden flex justify-center items-center text-sm space-x-1 absolute bottom-16 w-full px-4 py-2 bg-black text-white ${
                              product.stock < 1
                                ? "bg-gray-400 cursor-not-allowed"
                                : "hover:bg-amber-400"
                            }`}
